...
class ContactLocators:
    ...
    INPUT_COMPANY_NAME = (By.CSS_SELECTOR, 'form.contact__form input#company_name[name="company_name"]')
    ITEMS_REQUEST_SUBJECTS = (By.CSS_SELECTOR, 'div.form__select select#subject option')
    SELECT_SUBJECT = (By.CSS_SELECTOR, 'div.form__select select#subject')
